Public Class frmRegisterStd
    ...
    Private Sub frmRegisterStd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmRegisterStd_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        LoginForm1.Show()
    End Sub
